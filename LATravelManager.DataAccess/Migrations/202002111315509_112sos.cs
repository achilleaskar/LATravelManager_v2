namespace LATravelManager.DataAccess.Migrations
{
    ...
    public partial class _112sos : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Excursions", "Deactivated", c => c.Boolean(nullable: false, storeType: "bit"));
            ...
            AlterColumn("dbo.Bookings", "GroupBooking", c => c.Boolean(nullable: false, storeType: "bit"));
            AlterColumn("dbo.Bookings", "VoucherSent", c => c.Boolean(nullable: false, storeType: "bit"));
            AlterColumn("dbo.Bookings", "ProformaSent", c => c.Boolean(nullable: false, storeType: "bit"));
            AlterColumn("dbo.Bookings", "RoomingListIncluded", c => c.Boolean(nullable: false, storeType: "bit"));
            ...
            AlterColumn("dbo.Personal_Booking", "VoucherSent", c => c.Boolean(nullable: false, storeType: "bit"));
            AlterColumn("dbo.Personal_Booking", "ProformaSent", c => c.Boolean(nullable: false, storeType: "bit"));
            ...
            AlterColumn("dbo.NotifStatus", "IsOk", c => c.Boolean(nullable: false, storeType: "bit"));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.ThirdParty_Booking", "VoucherSent", c => c.Boolean(nullable: false));
            ...
            AlterColumn("dbo.NotifStatus", "IsOk", c => c.Boolean(nullable: false));
            ...
            AlterColumn("dbo.Personal_Booking", "ProformaSent", c => c.Boolean(nullable: false));
            AlterColumn("dbo.Personal_Booking", "VoucherSent", c => c.Boolean(nullable: false));
            ...
            AlterColumn("dbo.Bookings", "RoomingListIncluded", c => c.Boolean(nullable: false));
            AlterColumn("dbo.Bookings", "ProformaSent", c => c.Boolean(nullable: false));
            AlterColumn("dbo.Bookings", "VoucherSent", c => c.Boolean(nullable: false));
            AlterColumn("dbo.Bookings", "GroupBooking", c => c.Boolean(nullable: false));
            ...
            AlterColumn("dbo.Excursions", "Deactivated", c => c.Boolean(nullable: false));
